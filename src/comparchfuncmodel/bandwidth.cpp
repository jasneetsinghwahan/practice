/***
 * code copied from 
 * https://github.com/lemire/Code-used-on-Daniel-Lemire-s-blog/tree/master/2024/01/13
 * this code checks the memory bandwidth
 * this code couldn't be executed on my laptop, evebn afetr changing the stack
 * size to 16 GB and I kept on getting the std::bad_alloc error
*/
#include <chrono>
#include <thread>
#include <vector>
